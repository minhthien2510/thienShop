                ...
                <div class="col-md-9 main-wrap">
                    <div class="main-content">
                        <div class="shop-toolbar">
                            <form name="commerce-ordering" class="commerce-ordering clearfix">
                                ...
                                <div class="commerce-ordering-select">
                                    ...
                                    <div class="form-flat-select">
                                        <select name="per_page" class="per_page">
                                            <option value="12"<?= isset($_GET['per_page']) && $_GET['per_page'] == 12 ? 'selected' : ''?>>12</option>
                                            <option value="24"<?= isset($_GET['per_page']) && $_GET['per_page'] == 24 ? 'selected' : ''?>>24</option>
                                            <option value="36"<?= isset($_GET['per_page']) && $_GET['per_page'] == 36 ? 'selected' : ''?>>36</option>
                                        </select>
                                        <i class="fa fa-angle-down"></i>
                                    </div>
                                </div>
                                                            ...
                                                            @foreach ($images as $img)
                                                                @if ($img->pro_id == $item->id && $img->cover_image == 1)
                                                                    <a href="{{ route('product.detail', $item->slug) }}">
                                                                        <img width="450" height="450" src="{{ $img->name }}" alt="{{ $item->name }}"/>
                                                                    </a>
                                                                    @break;
                                                                @endif
                                                            @endforeach
                        ...
                        <nav class="commerce-pagination">
                            <p class="commerce-result-count">
                                Showing 1&ndash;<?= isset($_GET['per_page']) ? $_GET['per_page'] : 12 ?> of results
                            </p>
                            <div class="paginate">
