...
<html>
    <head>
        ...
        <!-- App title -->
        <title>Adminto - Responsive Admin Dashboard Template - @yield('title')</title>
        ...
        <div id="wrapper">
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div class="user-box">
                        <div class="user-img">
                            <img src="{{ asset('public/admin/assets/images/users/avatar-1.jpg') }}" alt="user-img" title="Mat Helme" class="img-circle img-thumbnail img-responsive">
                    ...
                    <ul class="list-group list-no-border user-list">
                        <li class="list-group-item">
                            <a href="#" class="user-list-item">
                                <div class="avatar">
                                    <img src="{{ asset('public/admin/assets/images/users/avatar-2.jpg') }}" alt="">
                                </div>
                                <div class="user-desc">
                        ...
                        <li class="list-group-item active">
                            <a href="#" class="user-list-item">
                                <div class="avatar">
                                    <img src="{{ asset('public/admin/assets/images/users/avatar-3.jpg') }}" alt="">
                                </div>
                                <div class="user-desc">
